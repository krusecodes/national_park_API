...
function findParks(baseUrl, stateArr, maxResults, apiKey) {
...
function watchForm() {
    $('.js-form').on('submit', function() {
        ...
        const apiKey = 'ohOOcn6q8Kl0pKFhLgMHCcXFE5MzBCFr36rhy9l3'
        findParks(baseUrl, stateArr, maxResults, apiKey);
    })
}
